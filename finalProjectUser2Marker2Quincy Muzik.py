...
dfMocapData = pd.read_csv(r'C:\Users\Quincy\Documents\UW Stout\Statistics for Engineers and Scientists\Final Project\Postures.csv', skiprows=range(2,5227),nrows=5076)
...
plt.title('Motion Capture Posture Data: User 2 Marker 2')
